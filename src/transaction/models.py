...
class TransactionManager(BaseManager):
    """
    Manager class for transaction
    """
    @transaction.atomic
    def pay_invoice(self, gateway, invoice, return_url, **kwargs):
        """
        Helper method to payment invoice

        :param str gateway: Payment gateway name that should be used to pay invoice
        :param Instance invoice: Invoice instance to be paid
        :param str return_url: Url string that user should redirect upon payment capture.
        :return tuple: redirect url, transaction instance
...
class Transaction(BaseModel, DateTimeFieldMixin):
    """
    Class to store transaction detail and payment gateway response
